...
libusb_device_handle *QUsbDevice::getdevHandle()
{
    Q_D(QUsbDevice);
    return d->m_devHandle;
}
/*!
    \class QUsbDevice
...
/*!
    \brief Default constructor.
*/
QUsbDevice::Id::Id(quint16 _pid, quint16 _vid, quint8 _bus, quint8 _port, quint8 _class, quint8 _subclass,libusb_device * _usb_device)
{
    pid = _pid;
    vid = _vid;
    bus = _bus;
